...
            }
    ...
    # =========================================================================
    # ALTERAÇÃO APLICADA AQUI: Removendo a injeção da configuração do Firebase 
    # Client (agora carregada estaticamente)
    # =========================================================================
...
    # extra_context['__firebase_config'] = firebase_client_config # REMOVIDO/COMENTADO
